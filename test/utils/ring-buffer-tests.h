...
void ring_buffer_simple_write_test(TestContext ctx) {
  RingBuffer buffer(5);
...
void ring_buffer_multiple_write_with_peerk_and_read_test(TestContext ctx) {
  RingBuffer buffer(5);
...
void ring_buffer_multiple_write_hitting_limit_test(TestContext ctx) {
  RingBuffer buffer(5);
  const char *data_1 = "ala ma kota";
